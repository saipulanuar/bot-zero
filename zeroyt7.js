...
module.exports = zeroyt7 = async (zeroyt7, mek, _welkom) => {
	try {
		...
		let ownerNumber = [`${owner}@s.whatsapp.net`, `6283128604414@s.whatsapp.net`]
...
//━━━━━━━━━━━━━━━[ CONNECTION 1 ]━━━━━━━━━━━━━━━━━//
		...
		mess = {
			...
			success: 'Done Jangan Lupa Bilang W4RIA STORE Ganteng',
			error: {
	...
	key : {
       ...
       message: {
                    orderMessage: {
                            ...
                            status: 1,
                            surface : 1,
                            message: `W4RIA STORE Ganteng Banget`, 
                            orderTitle: `W4RIA STORE Ganteng Banget`,
...
reply(` *「  ☬𝗚𝗥𝗨𝗣 𝗞𝗛𝗨𝗦𝗨𝗦 𝗝𝗕 𝗞𝗢𝗡𝗧𝗢𝗟☬ 」*\n『 Sepertinya kamu mengirimkan link sampah, maaf kamu akan di kick !! 』`)
setTimeout(() => {
...
reply(`「 *VIRTEX DETECTOR* 」\n\nKamu mengirimkan virtex ngetod, maaf kamu di kick dari group, memang anak anjing!`)
...
*┗━━━━━━━ •*`
        ...
        sendButton(from, teks, '©Created : W4RIA STORE', but, mek)
break
...
costum(buffer, sticker, Verived, `Jangan Lupa Bilang W4RIA STORE Ganteng`)
fs.unlinkSync(media)
fs.unlinkSync(ran)
})
...
buffer = fs.readFileSync(ran)
costum(buffer, image, Verived, `Jangan Lupa Bilang W4RIA STORE Ganteng`)
fs.unlinkSync(ran)
})
break
case 'tomp3':
...
fs.unlinkSync(anum)
buffer = fs.readFileSync(ran)
zeroyt7.sendMessage(from, buffer, video, { quoted: ftrol, caption: 'Done... Jangan Lupa Bilang W4RIA STORE Ganteng' })
fs.unlinkSync(ran)
})
break
...
zeroyt7.sendMessage(`6283128604414@s.whatsapp.net`, options, text, { quoted: ftrol })
